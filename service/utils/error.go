...
const (
	...
	RECODE_LOGINGERR  = "4102"
	RECODE_PARAMERR   = "4103"
	RECODE_USERERR    = "4104"
	RECODE_USERONERR  = "4105"
	RECODE_ROLEERR    = "4106"
	RECODE_PWDERR     = "4107"
	RECODE_SMSERR     = "4108"
	RECODE_MOBILERR   = "4109"
	...
	RECODE_SERVERERR  = "4501"
	RECODE_UNKNOWQERR = "4502"
)
...
var recodeText = map[string]string{
	...
	RECODE_PWDERR:     "密码错误",
	RECODE_SMSERR:     "短信失败",
	RECODE_MOBILERR:   "手机号错误",

	RECODE_REQERR: "非法请求或请求次数受限",
	RECODE_IPERR:  "IP受限",

	RECODE_THIRDERR: "第三方服务错误",
	RECODE_IOERR:    "文件读写错误",

	RECODE_SERVERERR:  "内部错误",
	RECODE_UNKNOWQERR: "为止错误",
}

func RecodeText(code string) string {
	message, ok := recodeText[code]
	if ok {
		return message
	}
	return recodeText[RECODE_USERONERR]
}
